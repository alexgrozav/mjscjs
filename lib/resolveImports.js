 ...
 * @returns {string|*}
 */
const resolveImport = (filePath, importPath, { tsconfig, extname, addExtname }) => {
     ...
     */
    if (/^\.\.?\//.test(importPath) && !importExtname && addExtname) {
 ...
 * @returns {string}
 */
export const resolveImports = async (filePath, targetPath, options) => {
